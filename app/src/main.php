    ...
    <div class="container">
        <div class="container">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-12">
                    <div class="text-center fs-24 font-roboto">Select your service to get started:</div>
                </div>
            ...
            <div class="col-xxl-9">
                <div class="row justify-content-between crow">
                    <div class="col-lg-5">
                        ...
                        <h3 class="text-white fs-72 fw-700 lh-1 text-center d-lg-none">4500+ loved their 1hr plumbing experience</h3>
                        <div class="text-center d-lg-none pt-4 pb-5">
                            <?= renderImg("cpr1.png", 'lib') ?>
